            ...
            <div class="table-container">
                <table class="table" style="width: 100%; border-collapse: collapse; background-color: transparent;">
                    ...
                    <tbody>
                        @php
                            $data = [
                                ['status' => 'Aktif', 'badge' => '#16423c', 'btn' => '#fca5a5'],
                                ['status' => 'Non-Aktif', 'badge' => '#7f1d1d', 'btn' => '#9ca3af'],
                                ['status' => 'Verifikasi', 'badge' => '#a16207', 'btn' => '#9ca3af'],
                            ];
                        @endphp
                        @foreach($data as $item)
                        <tr style="border-bottom: 1px solid #94a3b8;">
                            <td style="padding: 12px 20px; color: black; font-size: 13px; border: 1px solid #94a3b8;">RKM-1</td>
                            <td style="padding: 12px 20px; font-weight: 500; color: black; font-size: 13px; border: 1px solid #94a3b8;">Ahmad Suryo</td>
                            ...
                            <td style="padding: 12px 20px; border: 1px solid #94a3b8;">
                                <div style="display: flex; gap: 8px; justify-content: center;">
                                    <button style="background-color: #fcd34d; border: 1px solid black; width: 28px; height: 28px; border-radius: 6px; display: flex; align-items: center; justify-content: center; cursor: pointer;">
                                        <span class="material-icons" style="font-size: 16px; color: black;">edit</span>
                                    </button>
                                    <button style="background-color: {{ $item['btn'] }}; border: 1px solid black; width: 28px; height: 28px; border-radius: 6px; display: flex; align-items: center; justify-content: center; cursor: pointer;">
