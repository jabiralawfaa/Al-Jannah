...
<head>
    ...
    <title>Akses Ditolak - RKM Al-Jannah</title>
...
<body>
    <div class="error-box">
        ...
        <p class="error-message">Maaf, Anda tidak memiliki izin untuk mengakses halaman ini. Silakan hubungi pengurus jika Anda membutuhkan akses.</p>
