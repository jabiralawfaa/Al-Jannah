...
<head>
    ...
    <title>Halaman Tidak Ditemukan - RKM Al-Jannah</title>
...
<body>
    <div class="error-box">
        ...
        <p class="error-message">Maaf, halaman yang Anda cari tidak tersedia atau telah dipindahkan. Silakan periksa kembali tautan yang Anda gunakan.</p>
