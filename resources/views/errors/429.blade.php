...
<head>
    ...
    <title>Terlalu Banyak Permintaan - RKM Al-Jannah</title>
...
<body>
    <div class="error-box">
        ...
        <p class="error-message">Anda telah melakukan terlalu banyak permintaan dalam waktu singkat. Silakan tunggu beberapa saat sebelum mencoba lagi.</p>
