...
<head>
    ...
    <title>Dalam Pengembangan - RKM Al-Jannah</title>
...
<body>
    <div class="error-box">
        ...
        <h1 class="error-title">Dalam Pengembangan</h1>
        <p class="error-message">Maaf, fitur ini masih dalam tahap pengembangan. Silakan kembali lagi nanti. Tim kami sedang bekerja keras untuk menghadirkan pengalaman terbaik bagi Anda.</p>
        @auth
            <form action="{{ route('logout') }}" method="POST">
                @csrf
                <button type="submit" class="btn-home">Kembali ke Beranda</button>
            </form>
        @else
